...
public class Assignment_CircularFormation : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        for (int i = 0; i < units.Length; i++)
        {
            ...
            //Quaternion unitRotation = leader.rotation * Quaternion.AngleAxis(angle, Vector3.up);
            //Vector3 offset = unitRotation * Vector3.forward * formationRadius;
            //units[i].position = leader.position + offset;
            //units[i].rotation = unitRotation;
