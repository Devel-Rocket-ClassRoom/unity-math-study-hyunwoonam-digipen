...
public class Assignment_UIPopup : MonoBehaviour
{
    ...
    private void UpdateAnimation()
    {
        ...
        if (currentState == PopupState.Showing)
        {
            ...
            popupPanel.localScale = Vector3.Lerp(Vector3.zero, Vector3.one, easeT);
        ...
        else if (currentState == PopupState.Hiding)
        {
            ...
            popupPanel.localScale = Vector3.Lerp(Vector3.one, Vector3.zero, easeT);
