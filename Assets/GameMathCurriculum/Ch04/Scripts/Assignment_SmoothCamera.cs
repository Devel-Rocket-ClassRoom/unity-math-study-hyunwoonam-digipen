...
public class Assignment_SmoothCamera : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        currentZoomDistance = Mathf.SmoothDamp(targetZoomDistance, currentZoomDistance, ref zoomVelocity, zoomSmoothTime);
        //2. 위치
        ...
        //Vector3 lookTargetPosition = target.position + (Vector3.up * offset.y);
        //Vector3 directionToTarget = (lookTargetPosition - transform.position).normalized;
        //
